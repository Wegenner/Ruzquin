    ...
    <div class="row">
        <div class="col">
            <nav>
                <ul class="nav">
                    <?php
                        $urlPresupuestosNav = "/Ruzquin/backend/Presupuestos/PresupuestosTodos.php";
                        echo "<li><a href='$urlPresupuestosNav' class='menuLink'> Todos </a></li>"; 
                    ?>
                    <?php
                        $urlPresupuestosNav = "/Ruzquin/backend/Presupuestos/PresupuestosGraficos.php";
                        echo "<li><a href='$urlPresupuestosNav' class='menuLink' style='background: #2f698d'> Dashboard </a></li>"; 
                    ?>
                    <?php
                        $urlPresupuestosNav = "/Ruzquin/backend/Presupuestos/PresupuestosBusqueda.php";
